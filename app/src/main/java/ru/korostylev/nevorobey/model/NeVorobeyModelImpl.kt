...
import ru.korostylev.nevorobey.api.NeVorobeyApi
...
import ru.korostylev.nevorobey.dto.Answer.Companion.LETTER_IS_EXIST
import ru.korostylev.nevorobey.dto.Answer.Companion.LETTER_IS_NOT_EXIST
import ru.korostylev.nevorobey.dto.Answer.Companion.LETTER_POSITION_GUESSED
...
//        _wordsFromDB.value = usedWordsDao.getAllWord().value
    ...
    override suspend fun getRandomWord(wordSize: Int): String {
        val response = ru.korostylev.nevorobey.api.NeVorobeyApi.service.getRandomWord(wordSize)
    ...
    override suspend fun isWordExist(word: String): Boolean {
        try {
            val response = ru.korostylev.nevorobey.api.NeVorobeyApi.service.isWordExist(word.lowercase())
